  ...
  (ui/page
   ...
   (biff/form
    ...
    [:div.flex.items-center.gap-1
     [:span.text-gray-400.font-mono.text-sm.tracking-widest.uppercase "★ top secret"]
     [:span.text-4xl.font-black.tracking-tight.leading-none
      {:class "bg-gradient-to-r from-[#CD7672] to-[#138086] bg-clip-text text-transparent"}
      settings/app-name]
     [:span.text-gray-400.font-mono.text-sm.tracking-widest.uppercase "clearance: alpha ★"]]
